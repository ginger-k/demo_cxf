 ...
 * generated in the com.ceair.cxf.ws.spring.client.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAddressByMobileResponse_QNAME = new QName("http://server.spring.ws.cxf.ceair.com/", "getAddressByMobileResponse");
    private final static QName _GetAddressByMobile_QNAME = new QName("http://server.spring.ws.cxf.ceair.com/", "getAddressByMobile");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ceair.cxf.ws.spring.client.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.spring.ws.cxf.ceair.com/", name = "getAddressByMobileResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.spring.ws.cxf.ceair.com/", name = "getAddressByMobile")
